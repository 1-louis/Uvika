...
class __TwigTemplate_ba06bb387efb3bef725d992151d913aa4385e4fe673bfea3f869064f3dde95fe extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        echo "Valider ma commande - Uvika";
    }
    ...
    <p>Choisissez vos préférences avant de passer votre commande sur Uvika.</p>
    <hr>
    <div class=\"row\">
        <div class=\"col-md-6\">
            ";
...
";
    ...
    {
        return new Source("", "order/index.html.twig", "D:\\xampp\\htdocs\\Uvika\\templates\\order\\index.html.twig");
    }
}
