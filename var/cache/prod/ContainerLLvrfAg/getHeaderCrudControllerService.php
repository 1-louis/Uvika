...
class getHeaderCrudControllerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.Jaz8VFM'] ?? $container->load('get_ServiceLocator_Jaz8VFMService'))->withContext('App\\Controller\\Admin\\HeaderCrudController', $container));
